...
power_data4 <- read.csv("./household_power_consumption.txt", header=T, sep=';', na.strings="?", 
                        nrows=2075259, check.names=F, stringsAsFactors=F, comment.char="", quote='\"')
power_data4$Date <- as.Date(power_data4$Date, format="%d/%m/%Y")

## Subset data from 2007-02-01 to 2007-02-02
data <- subset(power_data4, subset=(Date >= "2007-02-01" & Date <= "2007-02-02"))
rm(power_data4)
...
## Plot4 histogram from 2007-02-01 to 2007-02-02
